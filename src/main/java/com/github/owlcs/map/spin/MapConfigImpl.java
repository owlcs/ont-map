...
public class MapConfigImpl implements MapConfig {
     ...
     * {@link SPINMAPL#self spinmapl:self} map-instructions,
     * that produces {@link com.github.owlcs.ontapi.jena.vocabulary.OWL#NamedIndividual owl:NamedIndividuals} declarations,
