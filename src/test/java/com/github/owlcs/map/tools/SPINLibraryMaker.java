...
import com.github.owlcs.map.spin.functions.spinmap.targetResource;
...
public class SPINLibraryMaker {
    ...
    public static void main(String... args) {
        ...
        SPINMAP.targetResource.inModel(m)
                .addProperty(AVC.optimize, targetResource.class.getName());

        // SPINMAPL:concatWithSeparator optimization
        SPINMAPL.concatWithSeparator.inModel(m)
                .addProperty(AVC.optimize, concatWithSeparator.class.getName());
        ...
        SPL.object.inModel(m)
                ...
                .addProperty(AVC.optimize, object.class.getName());
