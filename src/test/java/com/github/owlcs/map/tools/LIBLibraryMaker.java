...
import com.github.owlcs.map.spin.AdjustGroupConcatImpl;
import com.github.owlcs.map.spin.QueryHelper;
import com.github.owlcs.map.spin.SPINLibrary;
import com.github.owlcs.map.spin.functions.avc.UUID;
import com.github.owlcs.map.spin.functions.avc.objectWithFilter;
...
public class LIBLibraryMaker {
    ...
    public static void main(String... args) {
        ...
        AVC.UUID.inModel(m)
                ...
                .addProperty(AVC.optimize, UUID.class.getName())
                .addProperty(SPIN.body,
        ...
        AVC.objectWithFilter.inModel(m)
                ...
                .addProperty(AVC.optimize, objectWithFilter.class.getName())
